object frmIPaddrFilter: TfrmIPaddrFilter
  ...
  object GroupBox4: TGroupBox
    ...
    object EditAddNewUserTime: TSpinEdit
      Left = 65
      Top = 20
      Width = 47
      Height = 21
      ...
      TabOrder = 0
      Value = 5000
      OnChange = EditAddNewUserTimeChange
    end
    object EditChangePassword: TSpinEdit
      Left = 65
      Top = 44
      Width = 47
      Height = 21
      ...
      TabOrder = 1
      Value = 1000
      OnChange = EditChangePasswordChange
    end
    object EditLoadPassword: TSpinEdit
      Left = 65
      Top = 68
      Width = 47
      Height = 21
      ...
      TabOrder = 2
      Value = 2000
      OnChange = EditLoadPasswordChange
    end
  end
  object CheckBoxCheckClientMsg: TCheckBox
    ...
    Width = 70
    Height = 17
    Caption = #23553#21253#36807#28388
    TabOrder = 5

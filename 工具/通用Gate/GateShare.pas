...
var
  ...
  GateClass: string = 'GeneralGate';
  GateName: string = '通用网关';
  TitleName: string = 'GeneralGate';
  ...
  nAddNewUserTime: LongWord = 4000;
  nChangePassword: LongWord = 1000;
  nLoadPassword: LongWord = 2000;

object FormAccount: TFormAccount
  ...
  object GroupBox2: TGroupBox
    ...
    object CheckBoxPackEN: TCheckBox
      Left = 235
      Top = 125
      Width = 64
      Height = 17
      Caption = 'PAK'#21152#23494
      TabOrder = 24
      OnClick = CheckBoxAgentClick
    end
    object EditPackPassword: TEdit
      Left = 76
      Top = 123
      Width = 125
      Height = 20
  ...
  object GetUserNameList: TADOStoredProc
    Connection = FormMain.ADOConnection
    ProcedureName = 'GetUserNameList'
    Parameters = <
      item
        Name = '@Return_Value'
        DataType = ftInteger
  ...
  object GetUserInfoByID: TADOStoredProc
    Connection = FormMain.ADOConnection
    ProcedureName = 'GetUserInfoByID'
    Parameters = <
      item
        Name = '@Return_Value'
        DataType = ftInteger
  ...
  object DelUserInfoByID: TADOStoredProc
    Connection = FormMain.ADOConnection
    ProcedureName = 'DelUserInfoByID'
    Parameters = <
      item
        Name = '@Return_Value'
        DataType = ftInteger
  ...
  object SetUserInfo: TADOStoredProc
    Connection = FormMain.ADOConnection
    ProcedureName = 'SetUserInfo'
    Parameters = <
      item
        Name = '@Return_Value'
        DataType = ftInteger

...
uses
  ...
  Dialogs, ExtDlgs, ExtCtrls, Grids, StdCtrls, WIL;
...
begin
  ...
  if WMImages.Version > 1 then begin
    ...
    case ImageInfo.bitCount of
      16: begin
          case ImageInfo.biCompression of
            1: lblClass.Caption := lblClass.Caption + '(16位555)';
            2: lblClass.Caption := lblClass.Caption + '(16位565)';
          else
            lblClass.Caption := lblClass.Caption + '(16位)';
          end;
        end;
      24: begin
          lblClass.Caption := lblClass.Caption + '(24位)';
        end;
      32: begin
          lblClass.Caption := lblClass.Caption + '(32位)';
        end
    else
      lblClass.Caption := lblClass.Caption + '(256色)';
    end;
  end

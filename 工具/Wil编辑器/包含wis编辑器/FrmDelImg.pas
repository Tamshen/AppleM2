...
procedure TFormDelImg.Button1Click(Sender: TObject);
begin
  edtIndexStart.Text := IntToStr(StrToIntDef(edtIndexStart.Text, 1776) + 920);
  edtIndexEnd.Text := IntToStr(StrToIntDef(edtIndexEnd.Text, 1838) + 920);
end;

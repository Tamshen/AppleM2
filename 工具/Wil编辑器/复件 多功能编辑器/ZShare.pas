...
function RemoveData(FileStream: TFileStream; Offset, Size: Int64): Boolean;
function AppendData(FileStream: TFileStream; Offset, FSize: Int64): Boolean;
...
begin
  Result := True;
  FHandle := FileOpen(FileStream.FileName, fmOpenReadWrite or fmShareDenyNone);

...
type
  ...
  pTMagic = ^TMagic;
  TMagic = packed record//技能类
    wMagicId: Word;//技能ID
    sMagicName: string[10];//技能名称
...
//    boGameGoldBuy: Boolean;
 ...
 { TOldHumanUseItems = array[Low(THumanUseItems)..High(THumanUseItems)] of TUserItem;
  ...
  pTHumData = ^THumData;
  THumData = packed record{人物数据类 Size = 4402 预留N个变量}
    nIdx: Integer;

...
//  Images_MyTiles = Images_ObjectEnd + 1;
  ...
  Images_DecoIcon2 = Images_DefMagIcon2 + 1;

  Images_END = Images_DecoIcon2;
var
  ...
  for I := Low(g_ClientImages) to High(g_ClientImages) do begin
    ...
    case I of
     ...
     // Images_MyTiles: g_ClientImages[I] := g_WMyTilesImages;
      ...
      Images_DecoIcon2: g_ClientImages[I] := g_WDeco;//关键字锁人
...
begin
  ...
  g_WDeco := CreateWMImages(t_wmMyImage);//关键字锁人
...
//  g_WMagic4Images.ChangeAlpha := True;
 ...
 // g_WMagic9Images.ChangeAlpha := True;
  ...
  g_WDeco.FileName := DECOFILE;
  g_WDeco.LibType := ltUseCache;
  g_WDeco.Password := password;
  InitializeImage(g_WDeco);

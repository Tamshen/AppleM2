...
type
  ...
  ['{14AD0876-19A5-4B13-B2D8-46ECE1E336BA}']
   ...
   { function Texture_Load(const ImageData: Pointer; const ImageSize: Longword;
    ...
    function GetD3DCaps: PD3DCaps8;
    property D3DCaps: PD3DCaps8 read GetD3DCaps;
...
begin
  ...
  if not Assigned(FDepth) then
    PHGE.FD3DDevice.CreateDepthStencilSurface(FWidth,FHeight, D3DFMT_D16, D3DMULTISAMPLE_NONE, FDepth);
end;
...
function THGEImpl.GetD3DCaps: PD3DCaps8;
begin
  Result := @FD3DCaps;
end;
...
function THGEImpl.GetD3D: IDirect3D8;
begin
  Result := FD3D;
end;
...
// Create D3D Device
  ...
  {if FHardwareTL then begin
    if (Failed(FD3D.CreateDevice(D3DADAPTER_DEFAULT,D3DDEVTYPE_HAL,FWndParent, D3DCREATE_HARDWARE_VERTEXPROCESSING,FD3DPP^,FD3DDevice))) then begin
